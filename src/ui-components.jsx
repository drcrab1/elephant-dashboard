                ...
                {contract.templateType === 'standard_supplementary' && (
                    <div className="flex-1 text-[17px] leading-relaxed space-y-6">
                        ...
                        <div className="mt-10 space-y-3 text-[14px]">
                            ...
                            <p>⑥ "수탁자"가 개인 사정으로 대체 차량(용차)을 사용하는 경우, 관련 법령에 따라 필요한 자격 및 보험에 가입된 차량과 운전자를 사용하여야 하며, 무자격 또는 무보험 차량을 사용해서는 아니 된다.</p>
                            <p>⑦ "수탁자"는 계약기간 중 본 계약에 따른 배송업무와 동일한 시간대에 타 택배(운송)사업자의 배송업무를 겸하여 수행하지 아니한다.</p>
                        </div>
